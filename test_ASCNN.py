...
class Net(nn.Module):
    def __init__(self, scale, in_channel=1, num_filters1=16, num_filters2=32, r=16):
    ...
    def forward(self, x, th=0.04, dilker=3, dilation=True, eval=False, no_mask=False):
        if eval == True:
